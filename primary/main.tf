# Primary FoundationDB Cluster - Main Configuration
terraform {
  required_providers {
    aws = {
...
output "cluster_file_string" {
  ...
  description = "FDB cluster file connection string"
}

output "coordinator_ips" {
  value = module.coordinators.private_ips
  description = "Coordinator node IPs"
}
